...
<head>
    ...
    <style>
        .login-image {
            background: url(https://avatars3.githubusercontent.com/u/43431081?s=460&v=4);
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Are you Admin?</h1>
                                </div>
                                <form action="/auth/login.do" class="user" method="post">
